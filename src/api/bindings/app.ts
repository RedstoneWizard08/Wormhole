 ...
 */
async getPlugins(pool: unknown | null) : Promise<__Result__<({ id: string; game: number; display_name: string; icon_url: string; banner_url: string; fallback_dir: string | null; resolvers: SourceMapping[] })[], string>> {
try {
 ...
 * See: [`Dirs`]
 */
async getDirs(pool: unknown | null) : Promise<__Result__<{ root: string; data: string; cache: string; temp: string }, string>> {
try {
 ...
 */
async getSourceId(sid: number, pool: unknown | null) : Promise<__Result__<string, string>> {
try {
 ...
 * See: [`Instance`]
 */
async getInstances(gameId: number, pool: unknown | null) : Promise<__Result__<({ id: number | null; name: string; game_id: number; data_dir: string; cache_dir: string; install_dir: string; description: string; created: number; updated: number; loader: string | null })[], string>> {
try {
 ...
 */
async getInstance(instanceId: number, pool: unknown | null) : Promise<__Result__<{ id: number | null; name: string; game_id: number; data_dir: string; cache_dir: string; install_dir: string; description: string; created: number; updated: number; loader: string | null }, string>> {
try {
 ...
 */
async addInstance(instance: Instance, pool: unknown | null) : Promise<__Result__<{ id: number | null; name: string; game_id: number; data_dir: string; cache_dir: string; install_dir: string; description: string; created: number; updated: number; loader: string | null }, string>> {
try {
 ...
 * - `instance_id` - The instance's ID in the database.
 */
async deleteInstance(instanceId: number, pool: unknown | null) : Promise<__Result__<null, string>> {
try {
 ...
 * - `game_id` - The game's ID in the database.
 */
async createInstance(name: string, gameId: number, pool: unknown | null) : Promise<__Result__<{ id: number | null; name: string; game_id: number; data_dir: string; cache_dir: string; install_dir: string; description: string; created: number; updated: number; loader: string | null }, string>> {
try {
    return { status: "ok", data: await TAURI_INVOKE("create_instance", { name, gameId, pool }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async updateInstance(instanceId: number, desc: string, pool: unknown | null) : Promise<__Result__<{ id: number | null; name: string; game_id: number; data_dir: string; cache_dir: string; install_dir: string; description: string; created: number; updated: number; loader: string | null }, string>> {
try {
    return { status: "ok", data: await TAURI_INVOKE("update_instance", { instanceId, desc, pool }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async info(gameId: number, pool: unknown | null) : Promise<__Result__<{ id: string; game: number; display_name: string; icon_url: string; banner_url: string; fallback_dir: string | null; resolvers: SourceMapping[] }, string>> {
try {
...
async searchMods(gameId: number, resolver: SourceMapping, instance: Instance, query: string | null, opts: { page: number; count: number } | null, pool: unknown | null) : Promise<__Result__<{ data: Mod[]; page: number | null; per_page: number | null; pages: number | null }, string>> {
try {
...
async getMod(gameId: number, resolver: SourceMapping, mid: string, pool: unknown | null) : Promise<__Result__<{ id: string; game_id: number | null; versions: ModVersion[]; name: string; source: number; icon: string | null; banner: string | null; desc: string | null; author: string | null; downloads: number; followers: number; url: string | null }, string>> {
try {
...
async getModVersions(gameId: number, resolver: SourceMapping, instance: Instance, mid: string, pool: unknown | null) : Promise<__Result__<({ id: string; name: string | null; file_name: string | null; size: string | null; hash: string | null; url: string | null })[], string>> {
try {
...
async getModVersion(gameId: number, resolver: SourceMapping, instance: Instance, mid: string, version: string, pool: unknown | null) : Promise<__Result__<{ id: string; name: string | null; file_name: string | null; size: string | null; hash: string | null; url: string | null }, string>> {
try {
...
async getDownloadUrl(gameId: number, resolver: SourceMapping, instance: Instance, project: string, version: string | null, pool: unknown | null) : Promise<__Result__<string, string>> {
try {
...
async launchGame(gameId: number, instance: Instance, pool: unknown | null) : Promise<__Result__<null, string>> {
try {
...
async sources(gameId: number, pool: unknown | null) : Promise<__Result__<string[], string>> {
try {
...
async getLatestVersion(gameId: number, resolver: SourceMapping, instance: Instance, mid: string, pool: unknown | null) : Promise<__Result__<{ id: string; name: string | null; file_name: string | null; size: string | null; hash: string | null; url: string | null }, string>> {
try {
 ...
 */
async installMod(gameId: number, item: Mod, version: { id: string; name: string | null; file_name: string | null; size: string | null; hash: string | null; url: string | null } | null, instance: Instance, pool: unknown | null) : Promise<__Result__<null, string>> {
try {
 ...
 */
async uninstallMod(gameId: number, item: DbMod, instance: Instance, pool: unknown | null) : Promise<__Result__<null, string>> {
try {
 ...
 * - `instance_id` - The instance's ID in the database.
 */
async getMods(instanceId: number, pool: unknown | null) : Promise<__Result__<({ id: number | null; mod_id: string; version_id: string | null; name: string; file_name: string; instance_id: number | null; source_id: number | null; size: number | null; hash: string | null; path: string })[], string>> {
try {
 ...
 */
async getLoaders(loader: ModLoaderType, pool: unknown | null) : Promise<__Result__<({ Vanilla: string } | { Forge: [string, string] } | { NeoForge: [string, string] } | { Fabric: [string, string] } | { Quilt: [string, string] } | "None")[], string>> {
try {
    return { status: "ok", data: await TAURI_INVOKE("get_loaders", { loader, pool }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 * - `loader` - The loader type.
 */
async getLatestLoader(loader: ModLoaderType, pool: unknown | null) : Promise<__Result__<{ Vanilla: string } | { Forge: [string, string] } | { NeoForge: [string, string] } | { Fabric: [string, string] } | { Quilt: [string, string] } | "None", string>> {
try {
 ...
 */
async installLoader(loader: ModLoader, instance: Instance, pool: unknown | null) : Promise<__Result__<{ id: number | null; name: string; game_id: number; data_dir: string; cache_dir: string; install_dir: string; description: string; created: number; updated: number; loader: string | null }, string>> {
try {
    return { status: "ok", data: await TAURI_INVOKE("install_loader", { loader, instance, pool }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
