...
async getInstances(gameId: number, pool: unknown | null) : Promise<__Result__<({ id: number | null; name: string; game_id: number; data_dir: string; cache_dir: string; install_dir: string; description: string; created: number; updated: number; loader: string | null })[], boolean>> {
try {
...
async getInstance(instanceId: number, pool: unknown | null) : Promise<__Result__<{ id: number | null; name: string; game_id: number; data_dir: string; cache_dir: string; install_dir: string; description: string; created: number; updated: number; loader: string | null }, boolean>> {
try {
...
async addInstance(instance: Instance, pool: unknown | null) : Promise<__Result__<{ id: number | null; name: string; game_id: number; data_dir: string; cache_dir: string; install_dir: string; description: string; created: number; updated: number; loader: string | null }, boolean>> {
try {
...
async createInstance(name: string, gameId: number, pool: unknown | null) : Promise<__Result__<{ id: number | null; name: string; game_id: number; data_dir: string; cache_dir: string; install_dir: string; description: string; created: number; updated: number; loader: string | null }, boolean>> {
try {
...
async updateInstance(instanceId: number, desc: string, pool: unknown | null) : Promise<__Result__<{ id: number | null; name: string; game_id: number; data_dir: string; cache_dir: string; install_dir: string; description: string; created: number; updated: number; loader: string | null }, boolean>> {
try {
...
async getMod(gameId: number, resolver: SourceMapping, mid: string, pool: unknown | null) : Promise<__Result__<{ id: string; game_id: number | null; versions: ModVersion[]; name: string; source: number; icon: string | null; banner: string | null; desc: string | null; author: string | null; downloads: number; followers: number; url: string | null }, boolean>> {
try {
...
async getLoaders(loader: ModLoaderType, pool: unknown | null) : Promise<__Result__<({ Vanilla: string } | { Forge: [string, string] } | { NeoForge: [string, string] } | { Fabric: [string, string] } | { Quilt: [string, string] } | "None")[], boolean>> {
try {
...
async installLoader(loader: ModLoader, instance: Instance, pool: unknown | null) : Promise<__Result__<{ id: number | null; name: string; game_id: number; data_dir: string; cache_dir: string; install_dir: string; description: string; created: number; updated: number; loader: string | null }, boolean>> {
try {
