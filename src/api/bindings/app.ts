...
async getMod(gameId: number, resolver: SourceMapping, mid: string, pool: unknown | null) : Promise<__Result__<{ id: string; game_id: number | null; versions: ModVersion[]; name: string; source: number; icon: string | null; banner: string | null; desc: string | null; author: string | null; downloads: number; followers: number }, boolean>> {
try {
...
async createInstance(name: string, gameId: number, pool: unknown | null) : Promise<__Result__<{ id: number | null; name: string; game_id: number; data_dir: string; cache_dir: string; install_dir: string; description: string; created: number; updated: number }, boolean>> {
try {
...
async updateInstance(instanceId: number, desc: string, pool: unknown | null) : Promise<__Result__<{ id: number | null; name: string; game_id: number; data_dir: string; cache_dir: string; install_dir: string; description: string; created: number; updated: number }, boolean>> {
try {
...
async getMods(instanceId: number, pool: unknown | null) : Promise<__Result__<({ id: number | null; mod_id: string; version_id: string | null; name: string; file_name: string; instance_id: number | null; source_id: number | null; size: number | null; hash: string | null })[], boolean>> {
try {
...
export type DbMod = { id: number | null; mod_id: string; version_id: string | null; name: string; file_name: string; instance_id: number | null; source_id: number | null; size: number | null; hash: string | null }
