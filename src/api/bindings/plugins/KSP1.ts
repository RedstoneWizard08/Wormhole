...
export const commands = {
    ...
    > {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("plugin:KSP1|search_mods", { resolver, query, opts }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    > {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("plugin:KSP1|get_mod", { resolver, id }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    > {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("plugin:KSP1|get_mod_versions", { resolver, id }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    > {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("plugin:KSP1|get_mod_version", { resolver, id, version }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getDownloadUrl(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("plugin:KSP1|get_download_url", {
                    resolver,
                    project,
                    version,
                }),
    ...
    async launchGame(instance: Instance): Promise<__Result__<null, boolean>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("plugin:KSP1|launch_game", { instance }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async sources(): Promise<__Result__<string[], boolean>> {
        try {
            return { status: "ok", data: await TAURI_INVOKE("plugin:KSP1|sources") };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
        }
