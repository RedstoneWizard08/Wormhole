...
export const commands = {
    ...
    ): Promise<__Result__<{ data: Mod[]; page: number | null; per_page: number | null }, boolean>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("plugin:KSP2|search_mods", { resolver, query, opts }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    > {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("plugin:KSP2|get_mod", { resolver, id }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    > {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("plugin:KSP2|get_mod_versions", { resolver, id }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    > {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("plugin:KSP2|get_mod_version", { resolver, id, version }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getDownloadUrl(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("plugin:KSP2|get_download_url", {
                    resolver,
                    project,
                    version,
                }),
